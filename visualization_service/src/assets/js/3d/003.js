(function($V) {
  ...
  var three003 = {
    ...
    createLights: function() {
      this.hemiLight = new THREE.HemisphereLight( 0x000000, 0xffffff, 0.3);
      this.hemiLight.castshadow = true;
      scene.add( this.hemiLight );

      this.light1 = new THREE.PointLight($V.hslToRgb(.3), 10, 50, 2);
      this.light1.position.set(1, 20, 1);
      scene.add(this.light1);

      this.light2 = new THREE.PointLight($V.hslToRgb(.6), 10, 50, 2);
